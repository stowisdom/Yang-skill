...
description: >
  Using three perspectives—A, B, and C—to explain how scientific and engineering knowledge can be elevated to the level of mental models and philosophical wisdom.
  Triggered when a user enters: "理工 <theory name, explanatory sentence>".
  The final output is an HTML file.
---
...
#work
##step1
模型理解user input：“理工及计算机科理论”所属领域并表达出来等待用户确认共识
