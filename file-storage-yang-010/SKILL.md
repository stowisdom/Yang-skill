...
description: "触发前缀：file:（硬匹配）。用户输入 file:路径。Set up file hierarchies, organize files into categories, and perform file operations."
alwaysAllow:
  - "Bash"
  - "Read"
  - "Write"
...
触发前缀 `file:` 为硬匹配，必须以此前缀开头才触发本 skill。
